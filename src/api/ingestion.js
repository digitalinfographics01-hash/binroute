  ...
  _insertOrderSafe(order) {
    runSql(`
      ...
      ON CONFLICT(client_id, order_id) DO UPDATE SET
        ...
        billing_company_name=excluded.billing_company_name, billing_state_id=excluded.billing_state_id,
        first_name=excluded.first_name, last_name=excluded.last_name, customers_telephone=excluded.customers_telephone,
        shipping_first_name=excluded.shipping_first_name, shipping_last_name=excluded.shipping_last_name,
        shipping_street_address=excluded.shipping_street_address, shipping_street_address2=excluded.shipping_street_address2,
        ...
        shipping_state=excluded.shipping_state, shipping_state_id=excluded.shipping_state_id,
        shipping_postcode=excluded.shipping_postcode, shipping_method_name=excluded.shipping_method_name, shipping_id=excluded.shipping_id,
        cc_orig_first_6=excluded.cc_orig_first_6, cc_orig_last_4=excluded.cc_orig_last_4,
        check_account_last_4=excluded.check_account_last_4, check_routing_last_4=excluded.check_routing_last_4,
        check_ssn_last_4=excluded.check_ssn_last_4, check_transitnum=excluded.check_transitnum,
        main_product_id=excluded.main_product_id, main_product_quantity=excluded.main_product_quantity,
        upsell_product_id=excluded.upsell_product_id, upsell_product_quantity=excluded.upsell_product_quantity,
        next_subscription_product=excluded.next_subscription_product, next_subscription_product_id=excluded.next_subscription_product_id,
        is_any_product_recurring=excluded.is_any_product_recurring, shippable=excluded.shippable,
        aid=excluded.aid, opt=excluded.opt, sub_affiliate=excluded.sub_affiliate,
        created_by_user_name=excluded.created_by_user_name, credit_applied=excluded.credit_applied, promo_code=excluded.promo_code,
        current_rebill_discount_percent=excluded.current_rebill_discount_percent, order_confirmed_date=excluded.order_confirmed_date,
        order_sales_tax=excluded.order_sales_tax, order_sales_tax_amount=excluded.order_sales_tax_amount,
        shipping_amount=excluded.shipping_amount, on_hold_by=excluded.on_hold_by,
        is_rma=excluded.is_rma, rma_number=excluded.rma_number, rma_reason=excluded.rma_reason, return_reason=excluded.return_reason,
        consent_required=excluded.consent_required, consent_received=excluded.consent_received,
        order_customer_types=excluded.order_customer_types, website_received=excluded.website_received, website_sent=excluded.website_sent,
        ip_address_lookup=excluded.ip_address_lookup,
        employee_notes=excluded.employee_notes, system_notes=excluded.system_notes, custom_fields=excluded.custom_fields
    `, [
