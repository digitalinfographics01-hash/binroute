...
CREATE TABLE IF NOT EXISTS orders (
  ...
  billing_street_address2 TEXT DEFAULT NULL,
  billing_company_name TEXT DEFAULT NULL,
  billing_state_id TEXT DEFAULT NULL,
  ...
  shipping_street_address2 TEXT DEFAULT NULL,
  ...
  shipping_state_id TEXT DEFAULT NULL,
  shipping_postcode TEXT DEFAULT NULL,
  shipping_method_name TEXT DEFAULT NULL,
  shipping_id TEXT DEFAULT NULL,
  -- Card original BIN (before card update)
  cc_orig_first_6 TEXT DEFAULT NULL,
  cc_orig_last_4 TEXT DEFAULT NULL,
  -- ACH / check fields
  check_account_last_4 TEXT DEFAULT NULL,
  check_routing_last_4 TEXT DEFAULT NULL,
  check_ssn_last_4 TEXT DEFAULT NULL,
  check_transitnum TEXT DEFAULT NULL,
  -- Product / subscription
  main_product_id INTEGER DEFAULT NULL,
  main_product_quantity INTEGER DEFAULT NULL,
  upsell_product_id INTEGER DEFAULT NULL,
  upsell_product_quantity INTEGER DEFAULT NULL,
  next_subscription_product TEXT DEFAULT NULL,
  next_subscription_product_id INTEGER DEFAULT NULL,
  is_any_product_recurring INTEGER DEFAULT 0,
  shippable INTEGER DEFAULT 0,
  -- Order metadata
  aid TEXT DEFAULT NULL,
  opt TEXT DEFAULT NULL,
  sub_affiliate TEXT DEFAULT NULL,
  created_by_user_name TEXT DEFAULT NULL,
  credit_applied REAL DEFAULT 0,
  promo_code TEXT DEFAULT NULL,
  current_rebill_discount_percent REAL DEFAULT 0,
  order_confirmed_date TEXT DEFAULT NULL,
  order_sales_tax REAL DEFAULT 0,
  order_sales_tax_amount REAL DEFAULT 0,
  shipping_amount REAL DEFAULT 0,
  on_hold_by TEXT DEFAULT NULL,
  -- Returns
  is_rma INTEGER DEFAULT 0,
  rma_number TEXT DEFAULT NULL,
  rma_reason TEXT DEFAULT NULL,
  return_reason TEXT DEFAULT NULL,
  -- Compliance / misc
  consent_required INTEGER DEFAULT 0,
  consent_received INTEGER DEFAULT 0,
  order_customer_types TEXT DEFAULT NULL,
  website_received TEXT DEFAULT NULL,
  website_sent TEXT DEFAULT NULL,
  ip_address_lookup TEXT DEFAULT NULL,
  -- Notes (from order_view only, NULL from bulk import)
...
async function initializeDatabase() {
  ...
  const migrations = [
    ...
    "ALTER TABLE orders ADD COLUMN billing_first_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN billing_last_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN billing_street_address TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN billing_street_address2 TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN billing_company_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN billing_state_id TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN first_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN last_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN customers_telephone TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_first_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_last_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_street_address TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_street_address2 TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_company_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_city TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_country TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_state TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_state_id TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_postcode TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_method_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN shipping_id TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN cc_orig_first_6 TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN cc_orig_last_4 TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN check_account_last_4 TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN check_routing_last_4 TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN check_ssn_last_4 TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN check_transitnum TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN main_product_id INTEGER DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN main_product_quantity INTEGER DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN upsell_product_id INTEGER DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN upsell_product_quantity INTEGER DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN next_subscription_product TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN next_subscription_product_id INTEGER DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN is_any_product_recurring INTEGER DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN shippable INTEGER DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN aid TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN opt TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN sub_affiliate TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN created_by_user_name TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN credit_applied REAL DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN promo_code TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN current_rebill_discount_percent REAL DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN order_confirmed_date TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN order_sales_tax REAL DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN order_sales_tax_amount REAL DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN shipping_amount REAL DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN on_hold_by TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN is_rma INTEGER DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN rma_number TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN rma_reason TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN return_reason TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN consent_required INTEGER DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN consent_received INTEGER DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN order_customer_types TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN website_received TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN website_sent TEXT DEFAULT NULL",
    "ALTER TABLE orders ADD COLUMN ip_address_lookup TEXT DEFAULT NULL",
